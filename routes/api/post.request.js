          ...
          switch (_COLLECTION_NAME) {
                ...
                _COLLECTION.findOne(_CHECKING_CRITERIA, function(existingCheckQueryError, existingDoc){
                  if (existingCheckQueryError != null){
                    ...
                    if (existingDoc != null){
                      ...
                      if (typeof _THREAD.phone != 'undefined') {
                        if (typeof _THREAD.phone.mobile != 'undefined'){
                          Modules.Functions._sendMessageForVerify(_THREAD.phone.mobile.content, _THREAD.phone.mobile.validation.token)
                          .then((response) => {
            ...
            case 'users':
              if ((typeof _THREAD.user_group_id != 'undefined') && (typeof _THREAD.password != 'undefined')){
                ...
                const _COLLECTION = _DB.collection(_COLLECTION_NAME),
                    ...
                    if (
                      ...
                      if (!isNaN(_STRIPED_CREDIT_CARD_NUMBER) && !isNaN(_EXPIRATION_MONTH) && !isNaN(_EXPIRATION_YEAR) && !isNaN(_CVC)){
                        ...
                        if (_IS_TRANSACTION_READY_TO_LAUNCH){
                          ...
                          .then((charge) => {
                            if ((typeof charge.status != 'undefined') && (charge.status === "succeeded")){
                              const _COLLECTION = _DB.collection('histories');
            ...
            case 'recover':
              const CHECKING_COLLECTION = _DB.collection('users');

              var _CHECKING_CRITERIA = {},
                  _TARGET_REQUEST_TYPE = '';

              if (typeof _THREAD.email != 'undefined'){
                _CHECKING_CRITERIA["email.content"] = _THREAD.email;
                _TARGET_REQUEST_TYPE = 'email';
              }else if (typeof _THREAD.phone != 'undefined'){
                _CHECKING_CRITERIA["phone.mobile.content"] = _THREAD.phone;
                _TARGET_REQUEST_TYPE = 'phone';
              }

              CHECKING_COLLECTION.findOne(_CHECKING_CRITERIA, function(existingCheckQueryError, existingDoc){
                if (existingCheckQueryError != null){
                  const RECURSIVE_CONTENT = Modules.Functions._throwErrorWithCodeAndMessage(existingCheckQueryError, 700);

                  res.json(RECURSIVE_CONTENT);
                }else{
                  if ((existingDoc != null) && (typeof _THREAD.target != 'undefined')){
                    if ((typeof existingDoc.phone != 'undefined') || (typeof existingDoc.email != 'undefined')){
                      if (typeof _THREAD.phone != 'undefined') {
                        Modules.Functions._sendMessageForRecover(_THREAD.phone, `${Modules.Functions._getEndpointOfAPI()}/${_THREAD.target.app_name.toLowerCase()}/recover/password/${existingDoc.email.validation.token}`)
                        .then((response) => {
                          //YOU CAN STORE YOUR RESPONSE IN DB
                        })
                        .catch((error) => {
                      ...
                      if (typeof _THREAD.email != 'undefined'){
                        Modules.Functions._sendRecoveryPassword(_THREAD.target.app_name, {
                          target: {
                            email: _THREAD.email,
                            token: existingDoc.email.validation.token,
                            created_at: _TODAY,
                            modified_at: _TODAY
                          }
                        })
                      ...
                      const RECURSIVE_CONTENT = Modules.Functions._throwErrorWithCodeAndMessage(`You should first fill the ${_TARGET_REQUEST_TYPE} field in your profile.`, 700);

                      res.json(RECURSIVE_CONTENT);
                    }
                  }else{
                    const RECURSIVE_CONTENT = Modules.Functions._throwErrorWithCodeAndMessage(`The ${_TARGET_REQUEST_TYPE} you entered was incorrect.`, 700);
            ...
            case 'auth':
              if (((typeof _THREAD.user_name != 'undefined') || (typeof _THREAD.userName != 'undefined') || (typeof _THREAD.email != 'undefined') || (typeof _THREAD.token != 'undefined') || (typeof _THREAD.phoneNumber != 'undefined') || (typeof _THREAD.phone_number != 'undefined')) && (typeof _THREAD.password != 'undefined')){
                ...
                const _COLLECTION = _DB.collection('endusers');
